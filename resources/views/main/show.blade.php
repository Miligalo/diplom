				...
				<div class="row">
					...
					<div class="col-md-5 ">
						<div id="product-main-img">
							<div class="product-preview">
								<img src="{{asset('storage/' . $good->preview_image)}}" width="220" height="500" alt="">
							</div>
						</div>
					</div>
					<!-- /Product main img -->
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">{{$good->offer_price}} <del class="product-old-price">{{$good->price}}</del></h3>
							...
							<ul class="product-links">
								<li>Category:</li>
								<li><a href="#">{{$good->category->title}}</a></li>
							</ul>
						</div>
					</div>
					<!-- /Product details -->
